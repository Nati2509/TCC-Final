...
class DadosPreconceito : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val botao11 = getView()?.findViewById<Button>(R.id.copy_pr11)

        val texto12 = getView()?.findViewById<TextView>(R.id.textView12text)
        val botao12 = getView()?.findViewById<Button>(R.id.copy_pr12)
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): DadosPreconceito {
            val fragment = DadosPreconceito()
            val args = Bundle()
