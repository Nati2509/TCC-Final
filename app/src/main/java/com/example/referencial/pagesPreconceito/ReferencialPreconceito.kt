...
class ReferencialPreconceito : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_referencial_preconceito, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): ReferencialPreconceito {
            val fragment = ReferencialPreconceito()
            val args = Bundle()
