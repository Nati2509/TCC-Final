package com.example.referencial.pagesPreconceito
...
class CitacoesPreconceito : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_citacoes_preconceito, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val botao1 = getView()?.findViewById<Button>(R.id.copy_pr1)

        val texto2 = getView()?.findViewById<TextView>(R.id.textView2)
        val botao2 = getView()?.findViewById<Button>(R.id.copy_pr2)

        val texto3 = getView()?.findViewById<TextView>(R.id.textView3)
        val botao3 = getView()?.findViewById<Button>(R.id.copy_pr3)

        val texto4 = getView()?.findViewById<TextView>(R.id.textView4)
        val botao4 = getView()?.findViewById<Button>(R.id.copy_pr4)

        val texto5 = getView()?.findViewById<TextView>(R.id.textView5)
        val botao5 = getView()?.findViewById<Button>(R.id.copy_pr5)

        val texto6 = getView()?.findViewById<TextView>(R.id.textView6)
        val botao6 = getView()?.findViewById<Button>(R.id.copy_pr6)

        val texto7 = getView()?.findViewById<TextView>(R.id.textView7)
        val botao7 = getView()?.findViewById<Button>(R.id.copy_pr7)

        val texto8 = getView()?.findViewById<TextView>(R.id.textView8)
        val botao8 = getView()?.findViewById<Button>(R.id.copy_pr8)

        val texto9 = getView()?.findViewById<TextView>(R.id.textView9)
        val botao9 = getView()?.findViewById<Button>(R.id.copy_pr9)

        val texto10 = getView()?.findViewById<TextView>(R.id.textView10)
        val botao10 = getView()?.findViewById<Button>(R.id.copy_pr10)
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): CitacoesPreconceito {
            val fragment = CitacoesPreconceito()
            val args = Bundle()
