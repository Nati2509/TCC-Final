...
class ReferencialViolencia : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_referencial_violencia, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): ReferencialViolencia {
            val fragment = ReferencialViolencia()
            val args = Bundle()
