...
class DadosEducacao : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dados_educacao, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val botao11 = getView()?.findViewById<Button>(R.id.copy_edu11)

        val texto12 = getView()?.findViewById<TextView>(R.id.textView12text)
        val botao12 = getView()?.findViewById<Button>(R.id.copy_edu12)
