package com.example.referencial.pagesPolitica
...
class DadosPolitica : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dados_politica, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): DadosPolitica {
            val fragment = DadosPolitica()
            val args = Bundle()
