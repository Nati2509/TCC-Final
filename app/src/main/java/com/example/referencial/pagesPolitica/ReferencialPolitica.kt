...
class ReferencialPolitica : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_referencial_politica, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): ReferencialPolitica {
            val fragment = ReferencialPolitica()
            val args = Bundle()
