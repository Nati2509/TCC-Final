...
class ReferencialSaude : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_referencial_saude, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): ReferencialSaude {
            val fragment = ReferencialSaude()
            val args = Bundle()
