...
class DadosTecnologia : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dados_tecnologia, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val botao7 = getView()?.findViewById<Button>(R.id.copy_te7)

        val texto8 = getView()?.findViewById<TextView>(R.id.textView8text)
        val botao8 = getView()?.findViewById<Button>(R.id.copy_te8)

        val texto9 = getView()?.findViewById<TextView>(R.id.textView9text)
        val botao9 = getView()?.findViewById<Button>(R.id.copy_te9)

        val texto10 = getView()?.findViewById<TextView>(R.id.textView10text)
        val botao10 = getView()?.findViewById<Button>(R.id.copy_te10)

        val texto11 = getView()?.findViewById<TextView>(R.id.textView11text)
        val botao11 = getView()?.findViewById<Button>(R.id.copy_te11)

        val texto12 = getView()?.findViewById<TextView>(R.id.textView12text)
        val botao12 = getView()?.findViewById<Button>(R.id.copy_te12)
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): DadosTecnologia {
            val fragment = DadosTecnologia()
            val args = Bundle()
