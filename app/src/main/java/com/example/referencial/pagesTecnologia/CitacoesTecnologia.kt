...
class CitacoesTecnologia : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_citacoes_tecnologia, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): CitacoesTecnologia {
            val fragment = CitacoesTecnologia()
            val args = Bundle()
