...
class DadosMeioAmbiente : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dados_meio_ambiente, container, false)
    }
