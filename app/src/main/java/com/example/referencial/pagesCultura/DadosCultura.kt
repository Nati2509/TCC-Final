...
class DadosCultura : Fragment(), View.OnClickListener {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): DadosCultura {
            val fragment = DadosCultura()
            val args = Bundle()
