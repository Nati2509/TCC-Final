...
class ReferencialSociedade : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_referencial_sociedade, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): ReferencialSociedade {
            val fragment = ReferencialSociedade()
            val args = Bundle()
