...
class CitacoesSociedade : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_citacoes_sociedade, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): CitacoesSociedade {
            val fragment = CitacoesSociedade()
            val args = Bundle()
