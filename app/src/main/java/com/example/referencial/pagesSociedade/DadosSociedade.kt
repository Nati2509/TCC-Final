package com.example.referencial.pagesSociedade
...
class DadosSociedade : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dados_sociedade, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): DadosSociedade {
            val fragment = DadosSociedade()
            val args = Bundle()
