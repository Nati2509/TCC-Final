...
class ReferencialJuventude : Fragment(), View.OnClickListener {
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): ReferencialJuventude {
            val fragment = ReferencialJuventude()
            val args = Bundle()
