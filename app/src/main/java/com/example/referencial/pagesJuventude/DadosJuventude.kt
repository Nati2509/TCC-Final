package com.example.referencial.pagesJuventude
...
class DadosJuventude : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dados_juventude, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val botao1 = getView()?.findViewById<Button>(R.id.copy_ju1)

        val texto2 = getView()?.findViewById<TextView>(R.id.textView2text)
        val botao2 = getView()?.findViewById<Button>(R.id.copy_ju2)

        val texto3 = getView()?.findViewById<TextView>(R.id.textView3text)
        val botao3 = getView()?.findViewById<Button>(R.id.copy_ju3)
        ...
        val botao7 = getView()?.findViewById<Button>(R.id.copy_ju7)

        val texto8 = getView()?.findViewById<TextView>(R.id.textView8text)
        val botao8 = getView()?.findViewById<Button>(R.id.copy_ju8)

        val texto9 = getView()?.findViewById<TextView>(R.id.textView9text)
        val botao9 = getView()?.findViewById<Button>(R.id.copy_ju9)

        val texto10 = getView()?.findViewById<TextView>(R.id.textView10text)
        val botao10 = getView()?.findViewById<Button>(R.id.copy_ju10)

        val texto11 = getView()?.findViewById<TextView>(R.id.textView11text)
        val botao11 = getView()?.findViewById<Button>(R.id.copy_ju11)

        val texto12 = getView()?.findViewById<TextView>(R.id.textView12text)
        val botao12 = getView()?.findViewById<Button>(R.id.copy_ju12)
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): DadosJuventude {
            val fragment = DadosJuventude()
            val args = Bundle()
